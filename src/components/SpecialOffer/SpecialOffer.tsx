    ...
    <>
      {
        ...
        <div className="relative bg-black">
          ...
          <button onClick={handleClick} className="absolute right-9 top-[50%] -translate-y-1/2">
            <Image width={34} height={34} src="/svg/close.svg" alt="Закрыть специальное предложение" />
          </button>
        </div>
      }
    </>
